...
const GameOverComponent = (props) => {
  ...
  const calculateWPM = () => {
    ...
    testDurationInMinutes =
      testDurationInMinutes == 0 ? 1 : testDurationInMinutes;
  ...
  useEffect(() => {
    const { id, username, totalTyped, correctKeys, incorrectKeys } = props;
      ...
      if (time !== "" && WPM !== null) {
        ...
        axios({
          ...
          data: {
            ...
            correctlyTypedCharacters: [...correctKeys].length,
            unproductiveKeystrokes: [...incorrectKeys].length,
            elapsedTime: time,
            WPM: WPM,
          },
        })
  ...
  return (
    <div style={styles.container}>
      <Header as="h2" style={styles.gameOver}>
        GAME OVER !
      </Header>
      <img
        style={styles.img}
        alt="Naruto"
        src="https://i.ytimg.com/vi/XdBrFPqSMpo/hqdefault.jpg"
      />
      <Header as="h4" style={styles.summary}>
        Lesson Summary
      </Header>
      <div ref={details} style={styles.table}>
        <Table basic="very" collapsing textAlign="center" style={styles.table}>
          <TableRow text="Total Typed Characters" value={props.totalTyped} />
          <TableRow
          ...
          <TableRow
            ...
            value={getPercent(
              [...props.incorrectKeys].length,
              props.totalTyped
            )}
            percent
          />
          <TableRow text="Elapsed time" value={time} />
          <TableRow text="WPM" value={calculateWPM()} />
        </Table>
      </div>
